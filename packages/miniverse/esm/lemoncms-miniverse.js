import { ReplaySubject, concat, zip } from 'rxjs';
...
function RunHooks(_name, _components, locals) {
  ...
  this.run = function () {
    ...
    if (_this.hooks.length === 0) {
      process.env.NODE_ENV !== "production" ? warning(true, 'RunHooks has run more times then he could handle.' + ("Should run: " + _this.willRun + ", Has run: " + _this.hasRun) + '@morty should return rxjs zip()') : void 0;
...
var MiniverseContext = createContext({});
  ...
  return function (Component) {
    if (!conf) {
      return function (props) {
        return React.createElement(MiniverseContext.Consumer, null, function (context) {
    ...
    function (_React$PureComponent) {
      ...
      function Subscriber(props, context) {
        ...
        _this.updateState = function (service, watcher, data) {
          ...
          if (!deepEqual(_this.state, oldState)) {
            if (_this.mounted) {
        ...
        var callback = {
          ...
          error: function error(service, watcher, _error) {
            process.env.NODE_ENV !== "production" ? warning(true, _error) : void 0;
      ...
      _proto.render = function render() {
        ...
        return React.createElement(Component, _extends({}, this.props, newProps, this.context));
      };
    ...
    return function (props) {
      return React.createElement(MiniverseContext.Consumer, null, function (context) {
        return React.createElement(Subscriber, _extends({}, props, context));
      });
    };
  };
});
...
export { createWatchers, unsubscribeWatchers, propName, propNameAuth, RunHooks as runHooks, MiniverseContext, Miniverse, Store, provideHooks, withMiniverse };
