...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    }, children, listen && _isFunction(listen) && React.createElement(FormSpy, {
      subscription: {
        values: true
      },
...
function Context$1(Component) {
  var TmpClass = function TmpClass(props) {
    ...
    var showText = !computedInvalid && text && React.createElement("div", {
    ...
    }, label), React.createElement(Component, _extends({}, props, {
...
var Condition$1 = (function (props) {
  return React.createElement(AppContext.Consumer, null, function (context) {
    return React.createElement(Condition, _extends({
      context: context
    }, props));
  });
});
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    return React.createElement(React.Fragment, null, React.createElement(Dropzone, {
      ...
      }, React.createElement("div", getRootProps(), React.createElement("input", getInputProps()), React.createElement("button", {
        type: "button",
