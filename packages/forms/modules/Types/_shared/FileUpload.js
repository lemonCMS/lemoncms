  ...
  render() {
    ...
    if (error) {
      return (
        <tr>
          <td colSpan={3}>
            <div className="file-upload-error">There was an error, try again or contact the site owner.</div>
          </td>
        </tr>
      );
    }
    ...
    return (
      <tr>
        <td className="file-upload-name">
          {file.preview && (
            <img src={file.preview} alt={file.name} className="img-thumbnail" style={{ maxWidth: '80px' }} />
          )}
        </td>
