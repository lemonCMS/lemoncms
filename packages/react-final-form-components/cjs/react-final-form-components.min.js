...
var React = require("react"),
  ...
  ReactDropzone = _interopDefault(require("react-dropzone")),
...
const Custom = e => {
  const { control: t, input: r, isDisabled: o, children: s, context: l } = e;
  return t
    ? React__default.createElement(
        reactBootstrap.FormControl,
        _extends({}, r, { componentClass: s, disabled: o })
      )
    : s({ input: r, context: l }, o);
};
(Custom.propTypes = {
  input: PropTypes.shape({
    name: PropTypes.string.isRequired,
...
class Dropzone extends React__default.Component {
    ...
    super(...e),
      ...
      (this.removeFromStack = e => {
        const { queue: t, formData: r } = this.state,
          ...
          s = t.filter(t => t.name !== e.name),
          l = r.filter(t => t.name !== e.name);
        o(l), this.setState({ queue: s, formData: l });
      }),
      (this.displayFiles = () => {
  ...
  addData(e, t) {
    const {
      ...
      { formData: o, queue: s } = this.state,
      { name: l, type: p, size: a } = e,
      n = [...s],
      i = [...o];
    i.push({ name: l, type: p, size: a, data: t }),
      n.push(e),
      this.setState({ queue: n, formData: i }, () => {
        r(i);
      });
  }
  render() {
...
const Password = e => {
  const { input: t, isDisabled: r, placeholder: o, readOnly: s } = e;
  return React__default.createElement(
    reactBootstrap.FormControl,
    _extends({}, t, {
      type: "password",
...
const Show = ({ condition: e, children: t, context: { checkCondition: r } }) =>
...
const Input = e => {
  const { input: t, type: r, isDisabled: o, placeholder: s, readOnly: l } = e;
  return React__default.createElement(
    reactBootstrap.FormControl,
    _extends({}, t, { type: r, disabled: o, placeholder: s, readOnly: l })
  );
};
(Input.propTypes = {
  input: PropTypes.shape({
...
const Error = e => {
  const {
    children: t,
    context: {
      status: { submitFailed: r, submitError: o, error: s }
    }
  } = e;
  return r
    ? React__default.createElement(
        ...
        { bsStyle: "danger" },
        t,
        React__default.createElement("div", null, s, o)
      )
    : null;
};
