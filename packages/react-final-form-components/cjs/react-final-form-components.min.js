...
function fieldGroup(e) {
  const t = t => {
    const {
        ...
        help: s,
        disabled: l,
        context: { checkCondition: p, layout: a },
        meta: { submitError: n, submitFailed: i, invalid: u, error: c }
      } = t,
      d = i && u,
      y = l && p(l);
    return React__default.createElement(
      reactBootstrap.FormGroup,
      { validationState: d ? "error" : null },
      r &&
        React__default.createElement(
          Col,
          _extends({ componentClass: reactBootstrap.ControlLabel }, a.label),
          r
        ),
      React__default.createElement(
        Col,
        ...
        (() =>
          null === o
            ? React__default.createElement(
                e,
                _extends({}, t, { computedInvalid: d, isDisabled: y })
              )
            : React__default.createElement(
                InputGroup,
                null,
        ...
        d &&
          c &&
          React__default.createElement(reactBootstrap.HelpBlock, null, c),
        d &&
          n &&
          React__default.createElement(reactBootstrap.HelpBlock, null, n)
      ),
