...
function fieldGroup(e) {
  const t = t => {
    const {
        ...
        meta: { submitFailed: n, invalid: i, error: u }
      } = t,
      c = n && i,
      d = l && p(l);
    return React__default.createElement(
      reactBootstrap.FormGroup,
      { validationState: c ? "error" : null },
      r &&
        React__default.createElement(
          Col,
      ...
      React__default.createElement(
        ...
        (() =>
          null === o
            ? React__default.createElement(
                e,
                _extends({}, t, { computedInvalid: c, isDisabled: d })
              )
            : React__default.createElement(
                InputGroup,
                null,
      ...
      c && u && React__default.createElement(reactBootstrap.HelpBlock, null, u),
