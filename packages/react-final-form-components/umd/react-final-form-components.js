(function(global, factory) {
...
})(this, function(exports, React, reactFinalForm, reactBootstrap, Dropzone) {
  "use strict";
  ...
  */
  ...
  var C = React__default.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
  C.hasOwnProperty("ReactCurrentDispatcher") ||
    (C.ReactCurrentDispatcher = {
      current: null
    });
  C.hasOwnProperty("ReactCurrentBatchConfig") ||
    (C.ReactCurrentBatchConfig = {
      suspense: null
    });
  ...
  var Z = React__default.Children.toArray,
    Pa = C.ReactCurrentDispatcher;

  var reactDomServer_browser_development = createCommonjsModule(function(
    module
  ) {
    {
      (function() {
  ...
  */
  ...
  var bootstrapUtils = createCommonjsModule(function(module, exports) {
    ...
    var _invariant = interopRequireDefault(browser$1);
